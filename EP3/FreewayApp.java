...
public class FreewayApp extends AbstractSimulation {
  ...
  public void initialize() {
    ...
    freeway.classp = control.getDouble("Truck porcentage");
    freeway.maximumVelocity0 = control.getInt("Maximum velocity for class 1");
    freeway.maximumVelocity1 = control.getInt("Maximum velocity for class 2");
  ...
  public void reset() {
    ...
    control.setValue("Truck porcentage", 0.2);
    control.setValue("Maximum velocity for class 1", 2);
    control.setValue("Maximum velocity for class 2", 1);
